...
namespace AdGuardTray.ViewModels
{
    public partial class LogsViewModel : ObservableObject
    {
        ...
        public void ApplyEntries(
            IEnumerable<QueryLogEntry> incomingEntries)
        {
            List<QueryLogEntry> snapshot =
                (incomingEntries ??
                 Enumerable.Empty<QueryLogEntry>())
                    .OrderByDescending(entry =>
                        ParseEntryTime(entry.Time))
        ...
        private IEnumerable<QueryLogEntry>
            BuildFilteredEntries()
        {
            string search =
                SearchText.Trim();

            IEnumerable<QueryLogEntry> filtered =
